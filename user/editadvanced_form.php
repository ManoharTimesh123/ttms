...
class user_editadvanced_form extends moodleform {
    ...
    public function definition() {
        ...
        // Custom changes for user form organization fields
        user_extended_form_elements($mform, $userid);
        ...
        $user = user_extended_set_data($user);
        $this->set_data($user);
    ...
    public function validation($usernew, $files) {
        ...
        $err += user_extended_validation($usernew, $files);
