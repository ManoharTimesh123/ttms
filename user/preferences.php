...
/* INTG Customization Start : User prefrence page redirect to user own profile page. */
...
/* INTG Customisation Start : Force redirect user to profile page */
$redirecturl = new moodle_url($CFG->wwwroot . '/user/profile.php', array('id' => $USER->id));
if (!is_siteadmin()) {
