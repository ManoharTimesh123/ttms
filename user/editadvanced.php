...
if ($returnto === 'profile') {
    ...
    /* INTG Customization Start : When the user edit their own profile, it redirect to this URL. */
    $returnurl = new moodle_url('/user/profile.php', array('userid' => $user->id));
...
// print_object($usernew);exit;
    ...
    add_updated_user_profile_field($usernew, $data_submitted);

    require_once($CFG->dirroot.'/local/user_management/lib.php');
    save_user_customdetails($usernew, $data_submitted);
