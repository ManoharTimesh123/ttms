...
function user_update_user($user, $updatepassword = true, $triggerevent = true) {
    ...
    profile_update_send_message($user->id, $USER->id, $templatename = 'user_profile_update', $emailtobesent = 1, $smstobesent = 1);

    $log_data = new stdClass();
    $log_data->template = $templatename;
    $log_data->touser = $user->id;
    $log_data->params = array('modified_username' => $USER->id);
