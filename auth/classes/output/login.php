...
class login implements renderable, templatable {
    ...
    /* INTG Customization Start : Set captcha variable */
    public $humanvarification = '';
    ...
    public function export_for_template(renderer_base $output) {
        ...
        /* INTG Customization Start : Set captcha variable */
        $data->humanvarification = $this->humanvarification;
        /* INTG Customization End */

        /* INTG Customization Start : Get setting value of self registration */
        $data->isenabledselfregistraion = get_config('local_self_registration', "enable_self_registration");
        /* INTG Customization End */
