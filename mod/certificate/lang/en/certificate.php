...
$string['certcenteraddress'] = 'Varun Marg, Defence Colony,New Delhi -110024';
$string['certcentername'] = 'State Council of Educational Research and Training';
$string['certcenternametag'] = '(An Autonomous Organization of Education Department of Govt. of NCT of Delhi)';
/* INTG Customization Start : strings for the certificate approval. */
$string['certificateapproval'] = 'Certificate approval';
$string['certificate:approve'] = 'Approve Certificates for users';
$string['training'] = 'Training';
$string['batch'] = 'Batch';
$string['certificateconfirmation'] = 'Are you sure you want to {$a} the certificate for this Participant?';
$string['statusupdateby'] = 'Status updated by';
$string['statusupdatetime'] = 'Status updated time';
