...
class mod_questionnaire_mod_form extends moodleform_mod {
    ...
    protected function definition() {
        ...
        /* INTG Customization Start : Assign activity to role settings*/
        $roleoptions = get_user_course_role();
        $mform->addElement('header', 'assignactivityheader', get_string('assignactivityheader', 'questionnaire'));
        $mform->addElement('select', 'assigned_user_role_id', get_string('assignactivity', 'questionnaire'),$roleoptions);
        $mform->addHelpButton('assigned_user_role_id', 'assigned_user_role_id','questionnaire' );
        /* INTG Customization End */
