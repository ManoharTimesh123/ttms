...
class backup_questionnaire_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        /* INTG Customization Start : Adding assigned_user_role_id field in questionnaire table backup */
        ...
        $questionnaire = new backup_nested_element('questionnaire', array('id'), array(
            ...
            'closedate', 'resume', 'navigate', 'grade', 'sid', 'timemodified', 'completionsubmit', 'autonum', 'assigned_user_role_id'));
        ...
        /* INTG Customization Start : Adding provided_by_user_roleid, received_by_user_roleid in questionnaire_response table backup*/
        $response = new backup_nested_element('response', array('id'), array(
            'questionnaireid', 'submitted', 'complete', 'grade', 'userid', 'provided_by_user_roleid', 'received_by_user_roleid'));
        /* INTG Customization End */
