...
/* INTG Customization Start : String changes*/
$string['assignactivityheader'] = 'Assign Activity to Role';
$string['assignactivity'] = 'Assign Activity to Role';
$string['assigned_user_role_id_help'] = 'Please select the course user rol for assigning this activity to perticuler role';
$string['useratingreport'] = 'View User Role Rating Response';
$string['pleaseselectuserrole'] = 'Please Select User Role';
