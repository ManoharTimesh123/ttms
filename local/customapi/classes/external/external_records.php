 ...
 * @package    local_customapi
 */
class external_records extends external_multiple_structure {
    /**
     * Constructor
     */
    public function __construct(
        ...
        $itemiddesc = 'External id for item'
    ) {
        parent::__construct(
            new external_single_structure(
                array(
                    ...
                    'externalid' => new external_value(PARAM_TEXT, $itemiddesc, VALUE_OPTIONAL),
                ), 'record'),
            'list of records', VALUE_OPTIONAL);
    }
}
