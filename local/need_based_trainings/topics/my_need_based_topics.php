...
$PAGE->set_url($CFG->wwwroot.'/local/need_based_trainings/my_need_based_topics.php');
...
$baseurl = new moodle_url($CFG->wwwroot . '/local/need_based_trainings/my_need_based_topics.php');

echo  render_need_based_topics([]);
