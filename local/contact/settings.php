...
if ($hassiteconfig) {
    ...
    // Add to email field in this plugin.
    $default = '';
    $name = 'local_contact/toemail';
    $title = get_string('toemail', 'local_contact');
    $description = get_string('toemail_description', 'local_contact');
