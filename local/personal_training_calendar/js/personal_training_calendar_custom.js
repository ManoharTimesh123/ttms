$(document).ready(function() {
    $('.personal-training').click(function () {
        $('#personaltrainingmodelpopup').modal('hide');
        $('#training-detail').html('');
        var trainingid = $(this).attr('id');
        $.ajax ({
            method:"POST",
            url: M.cfg.wwwroot + '/local/personal_training_calendar/training_detail_ajax.php',
            data: {'trainingid':trainingid},
            success: function(response){
                $('#personaltrainingmodelpopup').modal('show');
