...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        /* INTG Customization Start : Course custom fields addition to course form.*/
        course_extended_form_elements($mform, $course);
        ...
        /* INTG Customization Start : Course custom fields set data while course update.*/
        $course = course_extended_set_data($course);
        /* INTG Customization End. */
    ...
    function validation($data, $files) {
        ...
        /* INTG Customization Start : Course extended fields validation.*/
        $errors  = array_merge($errors, course_extended_validation($errors, $data, $files));
        /* INTG Customization End. */
