...
/* INTG Customization Start : Course custom fields to save on course update.*/
...
if ($returnto === 'url' && confirm_sesskey() && $returnurl) {
    ...
    if (!empty($id)) {
        ...
        /* INTG Customization Start : Change redirection to course management page when cancel the edit course form */
...
if ($editform->is_cancelled()) {
    ...
    if (empty($course->id)) {
        ...
        /* INTG Customization Start : Course custom fields to save on course creation.*/
        $ajaxdata = data_submitted();
        $data->course = $course->id;
        save_course_customdetails($data, $ajaxdata);
        /* INTG Customization End. */
