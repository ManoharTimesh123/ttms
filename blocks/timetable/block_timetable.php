        ...
        if (empty($this->instance)) {
            ...
            if ( $checkboxtoday || $checkboxthisweek || $checkboxnextxday ) {
                ...
                if ( $checkboxtoday == true&&$checkboxthisweek == false&&$checkboxnextxday == false ) {
                    ...
                    /*
                        INTG Customization Start : Remove redirection to # by replace href="#" to style='cursor: pointer' when applying filters.
                    */
                    if ( $checkboxtoday ) {
                        ...
                        $this->content->text .= ' style="cursor: pointer" data-mode="today" data-url="'.$url.'">';
                    ...
                    if ( $checkboxthisweek ) {
                        ...
                        $url = new moodle_url($CFG->wwwroot.'/blocks/timetable/ajax.php', $varparams);
                        $this->content->text .= ' <a class="dropdown-item timeblock'.$this->context->instanceid.'"
                        style="cursor: pointer" data-mode="thisweek" data-url="'.$url.'">
                    ...
                    if ( $checkboxnextxday ) {
                        ...
                        $url = new moodle_url($CFG->wwwroot.'/blocks/timetable/ajax.php', $varparams);
                        $this->content->text .= ' <a class="dropdown-item timeblock'.$this->context->instanceid.'"
                        style="cursor: pointer" data-mode="nextxday" data-url="'.$url.'">
            ...
            if ($ulayout == "thisweek" || $checkboxthisweek) {
                ...
                foreach ($calendarweek as $cal) {
                    ...
                    */
                    ...
                    <a class='dateblock".$this->context->instanceid."' style='cursor: pointer'
