 ...
 *
 * @package    block_training_facilitators
...
class block_training_facilitators extends block_base {
    /**
     * block initializations
     */

    public function init() {
        $this->title = get_string('pluginname', 'block_training_facilitators');
    }
    ...
    public function get_content() {
        ...
        $userexist = [];
        if (has_capability('block/training_facilitators:view', $context) || $viewall) {
            foreach ($groups as $group) {
                $allgroupusers = get_enrolled_users($context, '', $group->id);
                foreach ($allgroupusers as $allgroupuser) {
                    if ($DB->record_exists('role_assignments', ['userid' => $allgroupuser->id, 'roleid' => $facilitatorroleid, 'contextid' => $context->id])) {
