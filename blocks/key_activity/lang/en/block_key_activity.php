...
$string['pluginname'] = 'Key Activity';
...
$string['key_activity:myaddinstance'] = 'Add my instance';
$string['key_activity:addinstance'] = 'Add instance';
$string['key_activity:view'] = 'View key activity';
$string['manageusers'] = 'Manage Users';
$string['managebatches'] = 'Manage Batches';
$string['manageschools'] = 'Manage Schools';
$string['managedistzondiets'] = 'Manage Districts, Zones, DIETs';
