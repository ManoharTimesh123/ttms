...
/* INTG Customization Start : Adding $PAGE and $OUTPUT for use in activity access report page header and footer */
...
/* INTG Customization Start : Adding activity access report page header */
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);
$PAGE->set_title(get_string('ativityaccess', 'block_analytics_graphs'));
$PAGE->set_heading(get_string('ativityaccess', 'block_analytics_graphs'));
...
<?php
/* INTG Customization Start : For enable footer in activity access report page firstly comment 1410 line in lib/outputrequirementslib.php and then uncomment footer */
// echo $OUTPUT->footer;
/* INTG Customization End */
?>