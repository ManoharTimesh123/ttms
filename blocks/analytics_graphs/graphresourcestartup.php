...
/* INTG Customization Start : Adding $PAGE and $OUTPUT for use in select activity list report page header and footer */
...
/* INTG Customization Start : Adding select activity list report page header */
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);
$PAGE->set_title(get_string('ativitylist', 'block_analytics_graphs'));
$PAGE->set_heading(get_string('ativitylist', 'block_analytics_graphs'));
...
<?php 
/* INTG Customization Start : customized select activity list report page css for fix page layout */
?>
<div class = "my_text" style="left:0; right:0;top:0;
...
<?php
/* INTG Customization Start : For enable footer in select activity list report page firstly comment 1410 line in lib/outputrequirementslib.php and then uncomment footer */
// echo $OUTPUT->footer;
/* INTG Customization End */
?>