...
/* INTG Customization Start : Adding $CFG and $OUTPUT for use in assessment report page header and footer */
...
/* INTG Customization Start : Adding assessment report page header */
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);
$PAGE->set_title(get_string('assessmentreport', 'block_analytics_graphs'));
$PAGE->set_heading(get_string('assessmentreport', 'block_analytics_graphs'));
...
<?php
/* INTG Customization Start : For enable footer in assessment report page firstly comment 1410 line in lib/outputrequirementslib.php and then uncomment footer */
// echo $OUTPUT->footer;
/* INTG Customization End */
?>