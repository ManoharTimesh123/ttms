...
/* INTG Customization Start : Adding $PAGE and $OUTPUT for use in student hits report page header and footer */
...
/* INTG Customization Start : Adding student hits report page header */
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);
$PAGE->set_title(get_string('studenthits', 'block_analytics_graphs'));
$PAGE->set_heading(get_string('studenthits', 'block_analytics_graphs'));
...
<?php
/* INTG Customization Start : For enable footer in student hits report page firstly comment 1410 line in lib/outputrequirementslib.php and then uncomment footer */
// echo $OUTPUT->footer;
/* INTG Customization End */
?>