...
/* INTG Customization Start : Adding $PAGE and $OUTPUT for use in student timeaccess report page header and footer */
...
/* INTG Customization Start : Adding student timeaccess report page header */
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);
$PAGE->set_title(get_string('studentaccess', 'block_analytics_graphs'));
$PAGE->set_heading(get_string('studentaccess', 'block_analytics_graphs'));
...
<?php 
/* INTG Customization Start : customized student timeaccess report page css for fix page layout */
?>
<div style="width: 300px; min-width: 325px;left:10px; top:5px; border-radius: 0px;padding: 5px;
    border: 2px solid silver;text-align: center;">
    <?php 
    /* INTG Customization End */
    echo get_string('timeaccesschart_daysforstatistics', 'block_analytics_graphs'); ?>
...
<?php
/* INTG Customization Start : For enable footer in student timeaccess report page firstly comment 1410 line in lib/outputrequirementslib.php and then uncomment footer */
// echo $OUTPUT->footer;
/* INTG Customization End */
?>