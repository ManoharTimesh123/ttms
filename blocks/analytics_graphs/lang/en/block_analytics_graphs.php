...
/* INTG Customization Start : Adding string for block_analytics_graphs plugin */
$string['studenthits'] = 'Student hits report';
$string['quizsubmission'] = 'Quiz submission report';
$string['studentaccess'] = 'Student time access report';
$string['ativityaccess'] = 'Activity access report';
$string['ativitylist'] = 'Select activity list';
