...
function block_about_us_pluginfile($course, $birecordorcm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    global $DB, $CFG;
    ...
    if (!$file = $fs->get_file($context->id, 'block_about_us', 'content', 0, $filepath, $filename) || $file->is_directory()) {
        send_file_not_found();
    }
