...
class block_cocoon_tstmnls_2 extends block_base {
    ...
    function get_content() {
        ...
        if ($data->slidesnumber > 0) {
            ...
            <!-- INTG Customziation : replace class container to container-fluid -->
  ...
  <!-- INTG Customziation : added classes border-0 box-shadow d-flex details flex-column justify-content-between -->
    <div class="details border-0 box-shadow d-flex details flex-column justify-content-between">
    <!-- INTG Customziation : added here p tag -->
    <p data-ccn="slide_text'.$i.'"> '.format_text($data->$slide_text, FORMAT_HTML, array('filter' => true)).' </p>
    <!-- INTG Customziation : added classes align-items-center pt-3 -->
<div class="ccnTestImgBox align-items-center pt-3">
...
<!-- INTG Customziation : removed here div icon -->  
<!--div class="icon"><span class="fa fa-quote-left"></span></div-->
  </div>
</div>
<!-- INTG Customziation : removed here p tag and paste above -->
