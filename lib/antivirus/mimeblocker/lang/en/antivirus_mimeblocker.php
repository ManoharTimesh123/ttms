...
// INTG Customization : Changed virus found message.
//$string['virusfound'] = ' You can only upload one of the following file types : {$a->types}.';
$string['virusfound'] = ' This file does not seem to be valid, please check the allowed extensions and file content.';
