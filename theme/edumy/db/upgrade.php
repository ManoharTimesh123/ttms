...
function xmldb_theme_edumy_upgrade($oldversion) {
    ...
    if ($oldversion < 2020050618) {
     ...
     if ($oldversion < 2022120203.05) {

        // Define field course to be added to theme_edumy_courserate.
        $table = new xmldb_table('theme_edumy_courserate');
        $field = new xmldb_field('review', XMLDB_TYPE_TEXT, null, null, null, null, null, 'rating');
        ...
        // Edumy savepoint reached.
        upgrade_plugin_savepoint(true, 2022120203.05, 'theme', 'edumy');
    }
